...
import { IBookedDay, IBooking, IBookingDpo } from "../../types/booking.type";
import axiosInstance from "../api.service";
import { BookingCalendarAdaptor } from "./booking-calendar.adapter";

export const BookingCalendarAdminAPI = {
  ...
  async deleteBooking(id: string): Promise<IBooking | null> {
    try {
      const response = await axiosInstance.delete<IBooking>(`/bookings/${id}`);
